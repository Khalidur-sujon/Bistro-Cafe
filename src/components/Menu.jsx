	...
	return (
		<section className=" min-h-[1200px] ">
			...
			<motion.div
				...
				className=" top-80 lg:top-96 relative"
			>
				<div className="mx-auto container">
					<div className="lg:-mt-24 min-h-[590px] z-30 mb-8 md:mb-4 xl:mb-1">
										...
										<div className="flex flex-row lg:flex-col h-full">
											...
											<div className="bg-[#fff3e4] flex-1 flex flex-col justify-center px-6 lg:p-12 lg:max-h-[250px] xl:max-h-max">
												<div className="text-center">
													...
													<div className="my-1 text-accent font-semibold text-[20px] lg:text-[40px] lg:my-6">
														{price}
													</div>
													<div>{description}</div>
												</div>
					...
					<button className="btn capitalize mx-auto mt-10">
						{btnText}
					</button>
				</div>
			</motion.div>
